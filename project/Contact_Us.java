...
public class Contact_Us extends JFrame {
	...
	public Contact_Us() {
		...
		String add= "Survey No. 12, Opp. Hypercity Mall, Kasarvadavali, Ghodbunder Road, Thane West, Thane, Maharashtra, India 400615";
		...
		JLabel lblRushasmgmailcom = new JLabel("rush2asm@gmail.com");
		lblRushasmgmailcom.setFont(new Font("Tahoma", Font.PLAIN, 12));
		lblRushasmgmailcom.setBounds(252, 290, 140, 18);
		...
		JLabel label = new JLabel("+918433592979");
		label.setFont(new Font("Tahoma", Font.PLAIN, 12));
		label.setBounds(252, 315, 145, 21);
		contentPane.add(label);
		
		JLabel label_1 = new JLabel(" ");
		label_1.setIcon(new ImageIcon(Contact_Us.class.getResource("/images/ANOOJ_BACKGROUND_1_629x408.png")));
